...
parser.add_argument('--subset',
                    default='f',
                    type=str,
                    help='subset (options: a, b, c, d, e, f)')
parser.add_argument('--data_dir',
                    default='./data',
                    type=str,
                    help='directory that containing dataset, except imagenet (see data.py)')
parser.add_argument('--processed_cifar_dir', default='/data/datasets/cifarpro', type=str)
parser.add_argument('--imagenet_dir', default='/data/datasets/ImageNet', type=str)
...
parser.add_argument('--size', default=128, type=int, help='spatial size of image')
...
parser.add_argument('-s',
                    ...
                    type=str,
                    default='idc',
                    help='data condensation type (glad, idc, dsa, kip, random, herding)')
